...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'medicine shop', amount = {'name':'pranav','age':"24","Doc id":'1121242','disease':'malaria','medicine':'Atovaquone-proguanil'})
